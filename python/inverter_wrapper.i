...
// Even though Eigen::MatrixXd is just a typedef for Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>, our templatedInverse function doesn't compile correctly unless we also declare typemaps for Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>. Not totally sure why that is. 
